...
// 	clean, compile:sass, copy, bundle
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
gulp.task('dist:copy', ['dist:clean'], getTask('dist.copy'));
...
gulp.task('default', function (cb) {
	gulpSequence('compile:sass', (dev ? 'serve:dev:start' : 'serve:dist:start'), 'watch:public')(cb);
});